        ...
        <div className={`${padding} pb-4 mb-2 border-b border-slate-200 transition-all duration-300 ease-in-out`}>
          <div className="flex items-center justify-between">
            <h1 className={`${titleSize} font-bold text-slate-800`}>
              {activeStep === 0 && 'Ship Your Car Today'}
            ...
            <form className={`${padding} space-y-5 w-full max-w-none`} onSubmit={(e) => { e.preventDefault(); void step4.handleSubmit(submitLead)(); }}>
              ...
              <div className="flex items-start gap-2 px-1">
                ...
                <small className="text-[10px] text-slate-400 leading-relaxed">
                  By checking this box, you consent to receive recurring automated promotional calls and text messages from Cayad Services LLC. These communications may be delivered by an AI voice agent or other automated technology. Msg frequency varies. Msg & data rates may apply. Reply STOP to opt out or HELP for help. Consent is not required to make a purchase. View our
